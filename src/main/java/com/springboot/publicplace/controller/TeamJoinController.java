...
public class TeamJoinController {
    ...
    public ResponseEntity<ResultDto> joinTeam(@PathVariable Long teamId, HttpServletRequest servletRequest, String joinReason) {
    ...
    public ResponseEntity<List<TeamJoinResponseDto>> getJoinRequestList(@PathVariable Long teamId, HttpServletRequest servletRequest) {
    ...
    public ResponseEntity<TeamJoinDetailResponseDto> getJoinRequestDetail(@PathVariable Long requestId, HttpServletRequest servletRequest) {
    ...
    public ResponseEntity<ResultDto> approveJoinRequest(@PathVariable Long requestId, HttpServletRequest servletRequest) {
    ...
    public ResponseEntity<ResultDto> rejectJoinRequest(@PathVariable Long requestId, HttpServletRequest servletRequest) {
